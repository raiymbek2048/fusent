...
-- Create a merchant for the seller
INSERT INTO merchant (id, owner_id, name, description, payout_status, buy_eligibility, created_at, updated_at)
VALUES
    (uuid_generate_v4(), 'd7a3e5f0-1234-4567-89ab-cdef12345678', 'Тестовый магазин', 'Магазин для тестирования', 'active', 'online_purchase', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
