...
CREATE INDEX IF NOT EXISTS idx_saved_post_user ON saved_post(user_id);
CREATE INDEX IF NOT EXISTS idx_saved_post_post ON saved_post(post_id);
CREATE INDEX IF NOT EXISTS idx_saved_post_created ON saved_post(created_at);
...
CREATE INDEX IF NOT EXISTS idx_share_post ON share(post_id);
CREATE INDEX IF NOT EXISTS idx_share_user ON share(user_id);
CREATE INDEX IF NOT EXISTS idx_share_created ON share(created_at);
